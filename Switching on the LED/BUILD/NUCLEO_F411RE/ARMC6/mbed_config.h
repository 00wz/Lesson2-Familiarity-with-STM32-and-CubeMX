...
#define MBED_CONF_PLATFORM_CRASH_CAPTURE_ENABLED                          1                                                            // set by library:platform[NUCLEO_F411RE]
...
#define MBED_CONF_PLATFORM_FATAL_ERROR_AUTO_REBOOT_ENABLED                1                                                            // set by library:platform[NUCLEO_F411RE]
#define MBED_CONF_PLATFORM_MAX_ERROR_FILENAME_LEN                         16                                                           // set by library:platform
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_ENABLE_64_BIT                   1                                                            // set by library:platform
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_ENABLE_FLOATING_POINT           0                                                            // set by application[*]
...
#define MBED_CONF_PLATFORM_STDIO_MINIMAL_CONSOLE_ONLY                     1                                                            // set by application[*]
